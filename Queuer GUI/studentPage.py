...
class Ui_studentAppointmentWindow(object):
    ...
    def getAppointmentFunction(self):
        ...
        #schedule = self.dateTimeSchedule.text()
        #teacher = str(self.teacherComboBox.currentText())
        #details = self.inputDetails.text()
    ...
    def getPriorityFunction(self):
        ...
        count += 1
        if count == 1:
            self.priorityNumberMainStudent.setText(str(count).zfill(3))
        else:
            QtWidgets.QMessageBox.warning(self,'Warning', 'Only 1 Priority Number per User')

    def setupUi(self, studentAppointmentWindow):
        studentAppointmentWindow.setObjectName("studentAppointmentWindow")
        studentAppointmentWindow.resize(1300, 850)
        studentAppointmentWindow.setStyleSheet("background-color: rgb(21, 31, 41);\n"
"font: 12pt \"Nunito\";")
        self.appointmentFrame = QtWidgets.QFrame(studentAppointmentWindow)
...
"color: rgb(21, 31, 41);")
        ...
        self.applicationSubjectLabel.setGeometry(QtCore.QRect(110, 210, 191, 31))
...
"color: rgb(21, 31, 41);")
        ...
        self.inputSubject.setGeometry(QtCore.QRect(110, 240, 511, 31))
        self.inputSubject.setObjectName("inputSubject")
        self.setAppointmentButton = QtWidgets.QPushButton(self.appointmentFrame)
        self.setAppointmentButton.setGeometry(QtCore.QRect(110, 740, 151, 31))
        font = QtGui.QFont()
...
"background-color: rgb(21, 31, 41);")
        ...
        self.cancelButton.setGeometry(QtCore.QRect(520, 740, 101, 31))
        font = QtGui.QFont()
        font.setFamily("Montserrat")
        font.setPointSize(10)
        font.setBold(False)
...
"background-color: rgb(21, 31, 41);")
        ...
        self.setDateLabel.setGeometry(QtCore.QRect(110, 320, 151, 16))
...
"color: rgb(21, 31, 41);")
        ...
        self.detailsLabel.setGeometry(QtCore.QRect(110, 500, 171, 21))
...
"color: rgb(21, 31, 41);")
        ...
        self.teacherComboBox.setGeometry(QtCore.QRect(110, 440, 281, 22))
        ...
        self.getPriorityButton.setGeometry(QtCore.QRect(300, 740, 181, 31))
        font = QtGui.QFont()
        font.setFamily("Montserrat")
        font.setPointSize(10)
        font.setBold(False)
...
"background-color: rgb(21, 31, 41);")
        ...
        self.appointmentLabel = QtWidgets.QLabel(studentAppointmentWindow)
...
"color: rgb(231, 231, 231);")
        ...
        self.appointmentHistory = QtWidgets.QTableWidget(studentAppointmentWindow)
        self.appointmentHistory.setGeometry(QtCore.QRect(740, 530, 511, 271))
        ...
        self.appointmentHistory.setColumnWidth(0, 150)
        self.appointmentHistory.setColumnWidth(1, 200)
        self.appointmentHistory.setColumnWidth(2, 200)
        self.appointmentHistory.setColumnWidth(3, 200)

        self.historyLabel = QtWidgets.QLabel(studentAppointmentWindow)
        self.historyLabel.setGeometry(QtCore.QRect(960, 480, 71, 51))
...
"color: rgb(231, 231, 231);")
        ...
        self.appointments = QtWidgets.QTableWidget(studentAppointmentWindow)
        ...
        self.appointments.setColumnWidth(0, 150)
        self.appointments.setColumnWidth(1, 200)
        self.appointments.setColumnWidth(2, 200)
        self.appointments.setColumnWidth(3, 200)

        self.queuingSystemLabel_4 = QtWidgets.QLabel(studentAppointmentWindow)
...
"background-color: rgb(255, 255, 255);")
        ...
        self.nowServingFrame3 = QtWidgets.QFrame(studentAppointmentWindow)
...
"background-color: rgb(255, 255, 255);")
        ...
        self.viewFrame = QtWidgets.QFrame(studentAppointmentWindow)
        ...
        self.retranslateUi(studentAppointmentWindow)
        QtCore.QMetaObject.connectSlotsByName(studentAppointmentWindow)

    def retranslateUi(self, studentAppointmentWindow):
        _translate = QtCore.QCoreApplication.translate
        studentAppointmentWindow.setWindowTitle(_translate("studentAppointmentWindow", "Dialog"))
        self.applicationFormLabel.setText(_translate("studentAppointmentWindow", "APPOINTMENT FORM"))
        self.applicationSubjectLabel.setText(_translate("studentAppointmentWindow", "Appointment Subject"))
        self.setAppointmentButton.setText(_translate("studentAppointmentWindow", "SET APPOINTMENT"))
        self.cancelButton.setText(_translate("studentAppointmentWindow", "CANCEL"))
        self.setDateLabel.setText(_translate("studentAppointmentWindow", "Set Date"))
        self.detailsLabel.setText(_translate("studentAppointmentWindow", "Appointment Details"))
        self.teacherLabel.setText(_translate("studentAppointmentWindow", "Teacher"))
        self.teacherComboBox.setItemText(0, _translate("studentAppointmentWindow", "Mr. Lowee Oliva"))
        self.teacherComboBox.setItemText(1, _translate("studentAppointmentWindow", "Mr. Rangie Obispo"))
        self.teacherComboBox.setItemText(2, _translate("studentAppointmentWindow", "Mr. Patrick Mac"))
        self.teacherComboBox.setItemText(3, _translate("studentAppointmentWindow", "Ms. Bambi Jimenez"))
        self.getPriorityButton.setText(_translate("studentAppointmentWindow", "GET PRIORITY NUMBER"))
        self.appointmentLabel.setText(_translate("studentAppointmentWindow", "APPOINTMENTS"))
        item = self.appointmentHistory.horizontalHeaderItem(0)
        item.setText(_translate("studentAppointmentWindow", "Priority Number"))
        item = self.appointmentHistory.horizontalHeaderItem(1)
        item.setText(_translate("studentAppointmentWindow", "Schedule"))
        item = self.appointmentHistory.horizontalHeaderItem(2)
        item.setText(_translate("studentAppointmentWindow", "Teacher"))
        item = self.appointmentHistory.horizontalHeaderItem(3)
        item.setText(_translate("studentAppointmentWindow", "Details"))
        self.historyLabel.setText(_translate("studentAppointmentWindow", "HISTORY"))
        ...
        item.setText(_translate("studentAppointmentWindow", "Details"))
        self.queuingSystemLabel_4.setText(_translate("studentAppointmentWindow", "000"))
        self.nowServingMainStudent.setText(_translate("studentAppointmentWindow", "NOW SERVING"))
        self.priorityNumberMainStudent.setText(_translate("studentAppointmentWindow", "000"))


if __name__ == "__main__":
    import sys
    app = QtWidgets.QApplication(sys.argv)
    studentAppointmentWindow = QtWidgets.QDialog()
    ui = Ui_studentAppointmentWindow()
    ui.setupUi(studentAppointmentWindow)
    studentAppointmentWindow.show()
    sys.exit(app.exec_())
